...
function setup()
  return {
    properties = {
      max_speed_for_map_matching      = 140/3.6, -- 180kmph -> m/s
    ...
    vehicle_height = 2.65, -- in meters, 2.0m is the height slightly above biggest SUVs
    vehicle_width = 2.1, -- in meters, ways with narrow tag are considered narrower than 2.2m

    -- Size of the vehicle, to be limited mostly by legal restriction of the way
    vehicle_length = 7.0, -- in meters, 4.8m is the length of large or family car
